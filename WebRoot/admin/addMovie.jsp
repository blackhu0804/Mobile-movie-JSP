	...
	<div class="am-g tpl-g">
            ...
            <div class="tpl-content-wrapper" style="color: #fff;">
                <form class="am-form am-form-horizontal" action="./addMovieToSql.jsp" style="padding: 16px 48px;">
                    <div class="row">
                        <label>电影名:</label>
                        <input name="movieName" type="text" placeholder="请输入要添加的电影名称">
                    </div>
                    <div class="row">
                        <label>评分:</label>
                        <input type="number" name="score" placeholder="请输入要添加的电影评分">
                    </div>
                    <div class="row">
                        <label>演员:</label>
                        <input type="text" name="actor" placeholder="请输入要添加的电影演员">
                    </div>
                    <div class="row">
                        <label>导演:</label>
                        <input type="text" name="director" placeholder="请输入要添加的电影导演">
                    </div>
                    <div class="row">
                        <label>上映年份:</label>
                        <input type="text" name="year" placeholder="请输入要添加的电影上映年份">
                    </div>
                    <div class="row">
                        <label>分类:</label>
                    ...
                    <div class="row">
                        <label>详细介绍:</label>
                        <textarea name="detail"placeholder="请输入要添加的电影详细介绍"></textarea>
                    </div>
